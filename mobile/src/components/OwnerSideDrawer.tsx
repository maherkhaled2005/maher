...
export const OWNER_SECTIONS: RoleSectionItem[] = [
  ...
  { id: 16, label: 'مجتمع TecnoRexa والفيديوهات', sub: 'استعراض المحتوى والتفاعل المجتمعي', screen: 'WebCommunity', icon: Film, color: '#8B5CF6' },
...
export const MANAGER_SECTIONS: RoleSectionItem[] = [
  ...
  { id: 12, label: 'مجتمع TecnoRexa والفيديوهات', sub: 'متابعة المحتوى والتفاعل المجتمعي', screen: 'WebCommunity', icon: Film, color: '#8B5CF6' },
...
export const SUPPORT_SECTIONS: RoleSectionItem[] = [
  ...
  { id: 7, label: 'مجتمع TecnoRexa والفيديوهات', sub: 'متابعة التفاعل المجتمعي للعملاء', screen: 'WebCommunity', icon: Film, color: '#8B5CF6' },
...
export const MERCHANT_SECTIONS: RoleSectionItem[] = [
  ...
  { id: 9, label: 'مجتمع TecnoRexa والفيديوهات', sub: 'استعراض الفيديوهات وريلز المنتجات', screen: 'WebCommunity', icon: Film, color: '#8B5CF6' },
